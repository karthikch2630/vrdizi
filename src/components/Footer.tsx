        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-20">
          ...
          <div className="md:col-span-12 lg:col-span-5 flex flex-col items-start pr-8">
            ...
            <div className="flex gap-4 mt-8">
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/in/vr-dizi-20b920406/" aria-label="LinkedIn" className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 hover:bg-brand-red hover:text-white hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
              ...
              <a 
  href="https://www.facebook.com/profile.php?id=61588954289004"
  target="_blank"
  rel="noopener noreferrer"
  aria-label="Visit our Facebook page"
  className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 hover:bg-[#1877F2] hover:text-white hover:-translate-y-1 hover:shadow-lg transition-all duration-300"
>
  <svg 
  ...
  >
    <path d="M13.5 9H15V6h-1.5C11.57 6 10 7.57 10 9.5V11H8v3h2v7h3v-7h2.5l.5-3H13v-1.5c0-.28.22-.5.5-.5z"/>
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/vrdizi/" aria-label="Instagram" className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 hover:bg-brand-red hover:text-white hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
