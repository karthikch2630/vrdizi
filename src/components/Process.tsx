        ...
        <div className="container mx-auto max-w-7xl">
          ...
          >
            ...
            <button 
              ...
              className="relative z-10 shrink-0 px-10 py-4 bg-[#be1622] hover:bg-white hover:text-[#00082d] text-white text-[11px] font-bold uppercase tracking-[0.2em] rounded-xl transition-all duration-300 shadow-lg flex items-center gap-3 group"
            >
              Get Started
