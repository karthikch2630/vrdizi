      ...
      <section className="relative w-full min-h-[100svh] bg-[#00082d] flex flex-col items-center justify-start md:justify-center pt-32 pb-10 overflow-hidden font-sans px-4 sm:px-6">
        ...
        <div className="relative z-30 w-full max-w-6xl flex flex-col items-center">
          ...
          >
            ...
            {/* CTA Buttons */}
            <motion.div onClick={() => setIsModalOpen(true)} variants={fadeUp} className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-4 sm:mb-14 w-full sm:w-auto">
              ...
              <Link to="/contact" className="w-full sm:w-auto px-8 py-3.5 sm:py-4 bg-white/5 backdrop-blur-sm border border-white/20 text-white text-sm font-semibold rounded-lg hover:bg-white/10 hover:border-white/40 hover:scale-105 transition-all duration-300">
                Reach Us
              </Link>
            </motion.div>
          </motion.div>
